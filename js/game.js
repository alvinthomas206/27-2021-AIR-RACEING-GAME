class Game {
    ...
    birdsGroup.destroyEach();
     ...
     birdsGroup.destroyEach();
      ...
      invisibleGround2 = createSprite(14200,displayHeight+40460,1200,81000);
      invisibleGround2.visible=false

      wall = createSprite(1700,displayHeight-50,10,480)
    ...
    //  }
     ...
     // if(invisibleGround2.isTouching(players[player.index - 1])){
    //    player.distance += 50
    //    player.update();
    //  }


      if (gameState === 1||player.distance<1000) {
        player.distance -= 20
        player.update();
      }
 ...
 //   player.distance=0
    ...
    //players[index-1].x=img.x
    //players[index-1].y=img.y
//}
